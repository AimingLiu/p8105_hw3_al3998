...
```
  ...
  As we can see from the graphic,the `activity_count` of the 24-hour activity time courses suddenly drops during a specific period of time in almost everyday in a week which means that during this period of time the count of activity is small.Also, we can see from the graphic,there are about 2~3 peaks in `activity_count` which means during these peroid of time in  everyday,the count of activity is larger than count during other period of time in a day.
